...
const Terms = () => {
  const homeData = {
    headline: "Conterize Terms of Service",
    description: "",
    // subdescription:
  ...
  return (
    <>
      <Helmet>
        <title>Conterize - Terms of service</title>
        <meta
          name="description"
      ...
      >
        ...
        <span style={{ fontSize: "20px" }}>Last updated July 10,2022</span>
        <h2>AGREEMENT TO TERMS</h2>
        <p>
          These Terms of Use constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity (“you”)
          and Conterize Inc, doing business as Conterize ("Conterize", “we”,
          “us”, or “our”), concerning your access to and use of
          the https://conterize.com website as well as any other media form,
          ...
          and/or services: Content creation for startups. Our content creation
          service include blog posts, email copy, landing page copy, social
          media graphics and videos. (the “Marketplace Offerings”). In order to
          help make the Site a secure environment for the purchase and sale of
          ...
          the Marketplace Offerings, you have read, understood, and agree to be
        ...
        <p>
          ...
          linking to, or permitting the use or installation of
          ...
          caused to you relating to or resulting in any way from
        ...
        <p>
          ...
          in the United Kingdom. If you access the Site or the Marketplace
          ...
          to the United Kingdom, and you agree to have your data transferred to
        ...
        <p>
          ...
          of __________. Conterize Inc and yourself irrevocably consent that the
        ...
        <p>
          ...
          be __________ . The language of the proceedings shall be __________.
        ...
        <p>
          ...
          BE LIMITED TO THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE TWELVE
          (12) MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING. CERTAIN US
